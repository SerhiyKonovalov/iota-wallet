	...
	plugins: [
		...
		new CopyPlugin({
			patterns: [
				...
				// Копіювання файлу sitemap.xml
				{ from: `${paths.src}/sitemap.xml`, to: '../[name][ext]' },
				// Копіювання файлу robots.txt
				{ from: `${paths.src}/robots.txt`, to: '../[name][ext]' },
				// Копіювання файлу .htaccess
				{ from: `${paths.src}/.htaccess`, to: '../[name][ext]' },
				// Копіювання файлу index.php
				{ from: `${paths.src}/index.php`, to: '../[name][ext]' },
			],
		})
	],
	resolve: {
